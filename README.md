...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ranger-fm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10955&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ranger-fm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ranger-fm` can be installed with:

```
conda install ranger-fm
```

It is possible to list all of the versions of `ranger-fm` available on your platform with:
